    ...
    <div class="grid grid-cols-3 shadow-lg ring-1 ring-slate-400 p-4 rounded-lg my-2">
        ...
        <div>
            ...
            <div class="flex space-x-2 rounded-xl bg-gray-200 p-2 w-40 justify-center">
                <button class="w-4 p-2" on:click={()=>{}}>-</button>
                <span class="w-4 p-2">777</span>
                <button class="w-4 p-2" on:click={()=>{}}>+</button>
            </div>
        </div>
        ...
        <a  on:click={() => DeleteCart(product.id)}  href="javascript:window.location.href=window.location.href" class="m-auto">
